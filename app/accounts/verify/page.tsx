...
export default function VerifyAccountPage() {
  ...
  useEffect(() => {
    // Retrieve pending account details from sessionStorage
    const pending = sessionStorage.getItem("pendingAccount")
    if (!pending) {
  ...
  const handleFinish = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // For now, we just add the account to the database
      ...
      <div className="mx-auto max-w-md">
        ...
        <Card className="mt-4">
          <CardHeader className="text-center">
            ...
            <CardDescription>Enter your Fayda ID to verify you own this account</CardDescription>
          </CardHeader>
          <CardContent>
