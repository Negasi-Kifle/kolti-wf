  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          emailRedirectTo:
            process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/auth/verify-fayda`,
          data: {
            full_name: fullName,
          },
        },
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="mt-4">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">Create your Kolti Account</CardTitle>
            <CardDescription className="text-amharic">የኢትዮጵያን መለያዎን ይፍጠሩ</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignUp}>
              ...
              <div className="mt-4 text-center text-sm">
                ...
                <Link href="/auth/login" className="text-teal-600 underline underline-offset-4">
                  Log In
                </Link>
              </div>
            </form>
